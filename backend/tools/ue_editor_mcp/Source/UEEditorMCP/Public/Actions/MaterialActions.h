...
/** Lists UMaterialExpression classes discovered through reflection. */
class UEEDITORMCP_API FListMaterialExpressionClassesAction : public FMaterialAction
{
public:
	virtual TSharedPtr<FJsonObject> ExecuteInternal(const TSharedPtr<FJsonObject>& Params, FMCPEditorContext& Context) override;
...
protected:
	virtual bool Validate(const TSharedPtr<FJsonObject>& Params, FMCPEditorContext& Context, FString& OutError) override;
	virtual FString GetActionName() const override { return TEXT("list_material_expression_classes"); }

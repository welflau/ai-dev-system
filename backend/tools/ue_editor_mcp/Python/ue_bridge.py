...
class UEBridge:
    ...
    def find_actors_by_name(
        self,
        pattern: str,
        world_scope: Optional[str] = None,
    ) -> dict:
        params = {"pattern": pattern}
        if world_scope is not None:
            params["world_scope"] = world_scope
        return self.call("find_actors_by_name", **params)

    def get_runtime_widgets(
        self,
        world_scope: Optional[str] = None,
        ...
        if only_visible is not None:
            params["only_visible"] = only_visible
        return self.call("get_runtime_widgets", **params)

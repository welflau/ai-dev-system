...
async def handle_tool(name: str, arguments: dict[str, Any]) -> list[TextContent]:
    ...
    if name == "add_widget_component":
        ...
        if component_type == "UserWidget":
            resolved_class = params.pop("widget_class_path", None) or params.get("component_class")
            if not resolved_class:
                return [TextContent(type="text", text='{"success": false, "error": "component_type=UserWidget requires widget_class_path or component_class"}')]
            params["component_class"] = resolved_class

...
def test_invalid_context_token_rebinds_high_confidence_task(repo: Path) -> None:
    ...
    task = _begin(
        ...
        agent_id="copilot",
        session="ljc-session",
        goal="Fix ALJCDomainActor editor preview for LJC",
        active_files=["Source/P111/Systems/LJC/LJCDomainActor.cpp"],
    )
    ...
    result = _dispatch_tool(
        ...
        "memory_write",
        {
            ...
            "agent_id": "copilot",
            "workspace_id": "ToolTest",
            "content_markdown": "# ALJCDomainActor Editor Preview\n\nRebuild LJC editor preview through LJCDomainActor.",
            "record_kind": "decision",
            "scope": "personal",
            "system_area": "Source/P111/Systems/LJC",

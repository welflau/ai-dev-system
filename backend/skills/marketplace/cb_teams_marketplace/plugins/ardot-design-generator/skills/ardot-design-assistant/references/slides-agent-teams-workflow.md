...
5. Call `fetch_style_guide_tags`, select 5–10 fitting tags, then call `fetch_style_guide` with those tags — obtain visual style inspiration (color palette, typography, spacing, decorative patterns)

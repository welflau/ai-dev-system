...
- **`create_design`** — Create a new blank file for the style guide. Optionally accepts a `filename`. **Wait for a context update confirming it is ready** before proceeding.
